...
## **如有更改或新内容请提issues or prs, thanks~**
...
- ZhixuewangScoreExt已经成功上架[Microsoft Edge Addons](https://microsoftedge.microsoft.com/addons/detail/zhixuewangscoreext/ppkbngflajmbfhdjeaiccfdjohldjhld)（即Edge扩展应用商店）！现在可以在Edge内直接安装和更新而无需下载*.crx或*.zip自己加载解压缩的扩展啦 😄🎉
